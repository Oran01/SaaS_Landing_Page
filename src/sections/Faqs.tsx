...
/**
 * List of frequently asked questions used in the FAQ section.
 ...
 * Faqs Component
 *
 * Renders an FAQ section with expandable animated answers.
 * Each question can be clicked to reveal or hide its answer.
 *
 * @component
 * @returns The rendered FAQs section
 */
export default function Faqs() {
  // Tracks the currently selected/expanded question index
      ...
      <div className="container">
        ...
        <div className="mt-12 flex flex-col gap-6 max-w-xl mx-auto">
          {faqs.map((faq, faqIndex) => (
            ...
            >
              {/* Question row with clickable header */}
              <div
              ...
              {/* Animated collapsible answer area */}
              <AnimatePresence>
